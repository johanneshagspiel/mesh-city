...
class PriceTableTest(unittest.TestCase):
	...
	@parameterized.expand([["Google Maps", "static_map", 0, 1, 100000, [0, 0, -99999]]])
	...
	def test_undefined_usage_range(self):
		self.assertEqual(
			...
			PriceTableUtil.calculate_action_price("Google Maps", "geocoding", 500001, 1, 1000000)
		)
	...
	def test_exceed_quota(self):
		self.assertEqual(
			...
			PriceTableUtil.calculate_action_price("Google Maps", "geocoding", 1000, 1, 1)
		)
