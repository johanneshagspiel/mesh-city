...
class MainScreen:
	...
	def __init__(self, application):
		...
		up_arrow = Button(
			self.canvas, text="Up", width=6, height=3, command=None, bg="grey"
		)
		self.canvas.create_window(560, 685, window=up_arrow)

		right_arrow = Button(
			self.canvas, text="Right", width=6, height=3, command=None, bg="grey"
		)
		self.canvas.create_window(613, 714.5, window=right_arrow)

		down_arrow = Button(
			self.canvas, text="Down", width=6, height=3, command=None, bg="grey"
		)
		self.canvas.create_window(560, 744, window=down_arrow)

		left_arrow = Button(
			self.canvas, text="Left", width=6, height=3, command=None, bg="grey"
		)
