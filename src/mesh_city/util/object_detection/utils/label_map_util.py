...
from mesh_city.util.object_detection.protos import string_int_label_map_pb2
...
def get_label_map_hierarchy_lut(label_map_path_or_proto, include_identity=False):
  ...
  """
	...
	hierarchy_dict = {
		'ancestors': collections.defaultdict(list), 'descendants': collections.defaultdict(list)
	}
	max_id = -1
	for item in label_map.item:
