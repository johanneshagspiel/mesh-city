...
from object_detection.protos import (
	...
	ssd_pb2 as object__detection_dot_protos_dot_ssd__pb2,
)
...
_DETECTIONMODEL.fields_by_name['faster_rcnn'].containing_oneof = _DETECTIONMODEL.oneofs_by_name[
	'model']
...
DetectionModel = _reflection.GeneratedProtocolMessageType(
	'DetectionModel', (_message.Message, ),
	{
...
ExperimentalModel = _reflection.GeneratedProtocolMessageType(
	'ExperimentalModel', (_message.Message, ),
	{
