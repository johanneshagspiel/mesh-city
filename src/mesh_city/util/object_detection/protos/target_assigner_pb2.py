...
from object_detection.protos import (
	...
	region_similarity_calculator_pb2 as
...
_TARGETASSIGNER = _descriptor.Descriptor(
	...
	name='matcher',
	full_name='object_detection.protos.TargetAssigner.matcher',
	index=0,
	number=1,
	type=11,
	cpp_type=10,
	...
	full_name='object_detection.protos.TargetAssigner.similarity_calculator',
	index=1,
	number=2,
	type=11,
	cpp_type=10,
	...
	_descriptor.FieldDescriptor(
	name='box_coder',
	full_name='object_detection.protos.TargetAssigner.box_coder',
	index=2,
	number=3,
	type=11,
	cpp_type=10,
...
_TARGETASSIGNER.fields_by_name[
	'matcher'].message_type = object__detection_dot_protos_dot_matcher__pb2._MATCHER
_TARGETASSIGNER.fields_by_name[
	'similarity_calculator'
].message_type = object__detection_dot_protos_dot_region__similarity__calculator__pb2._REGIONSIMILARITYCALCULATOR
_TARGETASSIGNER.fields_by_name[
	'box_coder'].message_type = object__detection_dot_protos_dot_box__coder__pb2._BOXCODER
...
TargetAssigner = _reflection.GeneratedProtocolMessageType(
	'TargetAssigner', (_message.Message, ),
	{
