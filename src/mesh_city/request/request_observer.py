...
class RequestObserver:
	...
	def update_gui(self):
		images_to_download = "Progress: " + str(self.current_image) + " out of " + str(self.total_images) + " images"
		self.images_to_download_label["text"] = images_to_download

		time_remaining = "Time remaining for download: " + str(self.estimated_time_to_finish)
